...
src_bonus := checker.c bonus_util.c adjust_and_push.c improved_atoi.c index_fucntions.c list_util.c  more_index_func.c more_operations_util.c more_stack_utils.c operations_and_positions.c parser.c print_utils.c stack_util.c turky_sort.c 
...
$(NAME): $(src) $(src_libft) 
	$(COMPILER) $(FLAGS) $(NAME) $(src) $(src_libft)

bonus: $(src_bonus) $(src_libft) $(src_gnl)
	$(COMPILER) $(FLAGS) $(BONUS_NAME) $(src_bonus) $(src_libft) $(src_gnl)
clean:
	$(REMOVE) $(NAME)
